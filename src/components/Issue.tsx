      ...
      <div className="px-3 pt-3 rounded">
        ...
        <div className="mt-3 mb-4">
          <div className="progress-stacked" style={{ height: "25px" }}>
            ...
            >
              <div className="progress-bar overflow-visible bg-primary fw-bold">{(selectedIssue.outstanding / selectedIssue.totalAuthorized * 100).toFixed(1) + "%"}</div>
            </div>
            <div
              className="progress"
              role="progressbar"
            ...
            >
              <div className="progress-bar overflow-visible bg-success fw-bold">{(selectedIssue.unissued / selectedIssue.totalAuthorized * 100).toFixed(1) + "%"}</div>
            </div>
          </div>
        </div>
